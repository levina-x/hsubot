            ...
            if (CONFIG.ADMIN_ID == user_id) {
                if (text == '/start') {
                    ...
                    if (isClientUserStart) {
                        tg_bot.sendMessage(user_id, "Start Client UserBot Berhasil!")
                    } else {
                        tg_bot.sendMessage(user_id, "Start Client UserBot Gagal!")
                    }
                } else if (tanda == "-" && text.includes(" ")) {
                ...
                tg_bot.sendMessage(chat_id, "Kamu tidak punya akses!")
            }
    ...
    try {
        ...
        switch (update['_']) {
            ...
            case 'updateNewMessage':
                if (PESAN_TERBACA) tg_user.viewMessages(update.message.chat_id, update.message.id, true)
            ...
            */
                ...
                if (cur_user_id == CONFIG.ADMIN_ID) {
                    ...
                    } else if (update.authorization_state['_'] == get_auth_state[1]) {
                    ...
                    } else if (update.authorization_state['_'] == get_auth_state[2]) {
                    ...
                    } else if (update.authorization_state['_'] == get_auth_state[3]) {
